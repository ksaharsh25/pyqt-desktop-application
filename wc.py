...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.bgwidget.setGeometry(QtCore.QRect(-60, 0, 782, 698))
...
"font: 14pt \"MS Shell Dlg 2\";")
        ...
        self.loginbutton_2.clicked.connect(self.mainpage)
        self.loginbutton.clicked.connect(self.opensignup)
